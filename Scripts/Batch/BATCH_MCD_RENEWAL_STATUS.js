...
***********************/
/*------------------------------------------------------------------------------------------------------/
| Program: Batch Renewal.js  Trigger: Batch
| Client: Michigan MSP
|
...
|		and (ASI::MOTOR CARRIER OPERATIONS::Operation Type) = General Commodities or Household Goods or Temporary Discontinued) 
|       and (LP::Interstate UCR Status = Not Active)
| 
|	 	THEN: Update expiration status and date. Set expiration status to "About to Expire" and expiration date to "12/31/Current Year".
/------------------------------------------------------------------------------------------------------*/
/*------------------------------------------------------------------------------------------------------/
|
