			...
			if (isReadyRenew(parentLicenseCAPID)) {
				...
				if (renewalCapProject != null) {
					...
					if (activeLicense(parentLicenseCAPID)) {
						...
						logDebug("Removed existing Equipment List from Certificate of Authority")
						copyASITables(capID, parentLicenseCAPID);// update Cert Equip List from Renewal
						logDebug("Moved Renewal Equipment List to Certificate of Authority")
